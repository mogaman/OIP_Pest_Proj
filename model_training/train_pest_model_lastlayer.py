...
# Unfreeze ONLY the last layer of the base model
...
checkpoint = ModelCheckpoint('best_pest_model_lastlayer.h5', monitor='val_accuracy', save_best_only=True, verbose=1)
...
# Save final model
model.save("pest_classifier_mobilenetv2_lastlayer.h5")
