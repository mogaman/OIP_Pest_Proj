...
# Image generators with enhanced augmentation
...
checkpoint = ModelCheckpoint('best_pest_model.h5', monitor='val_accuracy', save_best_only=True, verbose=1)
...
# Save final model
model.save("pest_classifier_mobilenetv2_improved.h5")
